...
from .alignment_utils import project_timestamps_onto_transcript, split_transcript_text
...
class QwenAsrTranscriber(Transcriber):
    ...
    _split_transcript_text = staticmethod(split_transcript_text)
    _project_timestamps_onto_transcript = staticmethod(project_timestamps_onto_transcript)
